<?php
namespace Ipragmatech\Bannerblock\Block\Adminhtml\Slider;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setTemplate('Ipragmatech_Bannerblock::slider/grid/massaction_extended.phtml');
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                'label' => __('Delete'),
                'url' => $this->getUrl('bannerblock/*/massDelete'),
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                ...
                'url' => $this->getUrl('bannerblock/*/massStatus', ['_current' => true]),
                'additional' => [
                    'visibility' => [
                        'name' => 'status',
                        'type' => 'select',
    ...
    {
        return $this->getUrl('bannerblock/*/grid', ['_current' => true]);
    }

    /**
     * @param \Ipragmatech\Slider\Model\slider|\Magento\Framework\Object $row
     * @return string
     */
