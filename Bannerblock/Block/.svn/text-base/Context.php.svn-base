...
class Context extends \Magento\Framework\View\Element\Template\Context
{
     ...
     * @param \Ipragmatech\Bannerblock\Helper\Data $devToolHelper
     * @param \Magento\Framework\Registry $registry
	 * @param \Ipragmatech\Bannerblock\Model\Config $config
    ...
    public function __construct(
        ...
        \Ipragmatech\Bannerblock\Helper\Data $devToolHelper,
        \Magento\Framework\Registry $registry,
		\Ipragmatech\Bannerblock\Model\Config $config,
     ...
     * @return \Ipragmatech\Bannerblock\Helper\Data
     */
    public function getBannerblockHelper()
    {
	...
	/**
	 * Function for getting bannerblock model config object 
     * @return \Ipragmatech\Bannerblock\Model\Config
     */
