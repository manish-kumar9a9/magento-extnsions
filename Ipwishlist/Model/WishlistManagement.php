...
class WishlistManagement implements WishlistManagementInterface
{
    ...
    public function getWishlistForCustomer($customerId)
    {
		...
		$productStockObj = $objectManager->get('Magento\CatalogInventory\Api\StockRegistryInterface')->getStockItem($item->getProductId());
                $productInfo['quantity_and_stock_status'] = $productStockObj->getIsInStock();
                $data = [
