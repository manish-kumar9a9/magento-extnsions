<?php
/**
 * Copyright © 2015 Meggalife . All rights reserved.
 * 
 */
namespace Meggalife\Auth\Block;
...
class Context extends \Magento\Framework\View\Element\Template\Context
{
	...
	/**
     * @var \Meggalife\Auth\Model\Config
     */
    protected $_config;
     ...
     * @param \Meggalife\Auth\Helper\Data $devToolHelper
     * @param \Magento\Framework\Registry $registry
	 * @param \Meggalife\Auth\Model\Config $config
    ...
    public function __construct(
        ...
        \Meggalife\Auth\Helper\Data $devToolHelper,
        \Magento\Framework\Registry $registry,
		\Meggalife\Auth\Model\Config $config,
     ...
     * @return \Meggalife\Auth\Helper\Data
     */
	...
	/**
	 * Function for getting auth model config object 
     * @return \Meggalife\Auth\Model\Config
     */
